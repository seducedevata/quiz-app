...
try:
    ...
    CV2_AVAILABLE = False
    logging.warning("OpenCV not available - some image processing features disabled")
...
try:
    ...
    logging.warning("pdf2image not available - PDF to image conversion disabled")
...
try:
    ...
    logging.warning("transformers not available - AI captioning features disabled")
...
class MultimodalDocumentProcessor:
    ...
    def _init_ai_models(self):
        ...
        try:
            ...
            if TRANSFORMERS_AVAILABLE:
                ...
                logger.warning("Transformers not available - layout analysis disabled")
    ...
    def _convert_to_images(self, document_path: Path) -> List[Image.Image]:
        ...
        if document_path.suffix.lower() == ".pdf":
            ...
            if not PDF2IMAGE_AVAILABLE:
                raise ImportError("pdf2image not available - cannot convert PDF to images. Install with: pip install pdf2image")
    ...
    def _analyze_layout(self, image: Image.Image, page_num: int) -> List[DocumentRegion]:
        ...
        if not CV2_AVAILABLE:
            logger.warning("OpenCV not available - using fallback region detection")
